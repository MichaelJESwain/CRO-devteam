...
function createUIComponents() {
    ...
    faqCTA_mobile.innerHTML = `${faqCTAIcons[1]}`;

    
    faqCTA_desktop = document.createElement('button');
    faqCTA_desktop.setAttribute('class', 'faq-cta-desktop');
    faqCTA_desktop.innerHTML = `
                        <span class="faq-cta_icon">${faqCTAIcons[1]}</span>
                        <span class="faq-cta_text">${dictionary[window.digitalData.site.attributes.storeCountry].level1Title[1]}</span>
                        `;
                                ...
                                <div class="faq-ui-drawer-slider">
                                    <div class="faq-ui-drawer-info-container faq-ui-draw_level-one">
                                        <div class="faq-ui-drawer_header">             
                                                <h2>${dictionary[window.digitalData.site.attributes.storeCountry].level1Title[1]}</h2> 
                                    ...
                                    <div class="faq-ui-drawer-info-container faq-ui-draw_level-two">
                                        ...
                                        <button class="faq-return-button">
                                            ...
                                            <span class="faq-return-button-text">${dictionary[window.digitalData.site.attributes.storeCountry].level2BackButton_copy[1]}</span>
                                        </button>
                                    </div>
                                </div>
                            </div>`;
