const TH282 = {
    ...
    buildReccGrid: (module2Slides) => {
        ...
        reccGrid.innerHTML = `
            ...
            <div class="TH282_reccGrid_content TH282_reccGrid_content_initialView">
            </div>
        ...
        document.querySelector('[data-testid="Recommendations-component-pdp_rec_injection2"]').parentElement.insertBefore(reccGrid, document.querySelector('[data-testid="Recommendations-component-pdp_rec_injection2"]'));
