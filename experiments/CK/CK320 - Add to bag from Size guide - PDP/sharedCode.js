...
// Diagnostic goals
// CK320 – Click on Add to Cart button in size guide
utils.observeSelector('.exp-add-to-bag button', function(){
    document.querySelector('.exp-add-to-bag button').addEventListener('click', () =>{
        window.fireBothEvents("CK320 - Click on Add to Cart in Size Guide")
    })
})