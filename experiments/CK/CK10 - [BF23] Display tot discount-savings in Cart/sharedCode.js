...
if(optimizely) {
  ...
  optimizely.optimizelyTools.stylesPalette = {
      v1: {
        discountFont: 'rgb(0, 0, 0)',
        totSavingBannerFont: 'rgb(0, 0, 0)',
        totSavingBannerBg: 'rgb(244, 244, 244)',
      },
      v2: {
        discountFont: 'rgb(225, 0, 0)',
        totSavingBannerFont: 'rgb(0, 0, 0)',
        totSavingBannerBg: 'rgb(244, 244, 244)',
      }
	};
  ...
  optimizely.optimizelyTools.getPalette = (version) => {
    ...
    entries.forEach((entry) => {
      if (entry.isIntersecting) {
        optimizely.sendAnalyticsEvents("CK10 - Changes seen");
        observer.disconnect();
      }
    });
  };
