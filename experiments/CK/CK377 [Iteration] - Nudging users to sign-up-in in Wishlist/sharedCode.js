window.ck377 = {
    ...
    translations: {
        uk: {
v1: "The items in your Wishlist are saved for a limited time. to keep them in your favourites!",
link: "Sign in or register",
...
optimizely.utils.waitForElement('[data-testid="filledWishlist-sign-in-pvh-button"]').then(function(btn){
    btn.addEventListener('click', () => {
        optimizely.sendAnalyticsEvents("CK377-TH150.2 - Clicks on Log in")
     })
})
